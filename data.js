...
export const orionData = {
    ...
    stars: [
        // Main stars of Orion with scaled positions and z-depth based on distance
    ...
    connections: [
        ...
        [2, 8], [8, 10], [9, 10], [10, 11] // Bow section connections
    ]
};
...
export const bigDipperData = {
    ...
    stars: [
        // Big Dipper stars with 3D depth data for zoom animations
...
export const cassiopeiaData = {
    ...
    position: { x: 75, y: -30, z: 0 },
    stars: [
        // Cassiopeia's M shape with 3D depth for zoom effects
